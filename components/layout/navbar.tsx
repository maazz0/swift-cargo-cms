        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {isAuthenticated ? (
            <>
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-3 pl-2 border-l dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/50 rounded-lg p-1 transition-colors"
                >
                ...
                {showProfileMenu && (
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-56 rounded-xl border bg-white shadow-lg dark:bg-slate-900 dark:border-slate-800 z-20 py-2">
                      <div className="px-4 py-3 border-b dark:border-slate-800">
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">{user?.email || 'admin@swiftcargo.com'}</p>
                      </div>
                      ...
                      <div className="py-1">
                        <button
                          ...
                          className="w-full flex items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 dark:text-slate-300 dark:hover:bg-slate-800 transition-colors"
                        >
                      ...
                      <div className="border-t dark:border-slate-800 py-1">
                        <button
                          onClick={() => {
                            setShowProfileMenu(false)
                            logout()
                          }}
                          className="w-full flex items-center gap-2 px-4 py-2 text-sm text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-950/20 transition-colors"
                        >
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/tracking"
                className="hidden sm:inline-flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-slate-600 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800 transition-colors"
              >
